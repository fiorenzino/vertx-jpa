 ...
 */
public abstract class JPATestBase extends VertxTestBase
{
  ...
  static
  {
    ...
    SQL.add("create table users (uuid varchar(100), name varchar(255), surname varchar(255), age int, birthday date);");
    SQL.add("insert into users values ('" + UUID.randomUUID().toString() + "', 'fiorenzo', 'pizza', 42, '1975-02-11');");
