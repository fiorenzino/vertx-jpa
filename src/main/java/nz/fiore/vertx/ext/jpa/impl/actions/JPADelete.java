 ...
 */
public class JPADelete extends AbstractJDBCAction<UpdateResult>
{
/*
 ...
 */
  ...
  public JPADelete(Vertx vertx, JPAStatementHelper helper, SQLOptions options, ContextInternal ctx, String table,
    JsonObject key)
  {
